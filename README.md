...
* Outils et concepts utilisés : SQL, CTE, Fonctions d’agrégation, Fonctions Windows, Jointures, Variables, Vues.
...
* Outils et concepts utilisés : Tableau, SQL, Excel, Actions, Filtres.
...
* Outils et concepts utilisés : SQL, CTE, Excel, Fonctions d'agrégaton, Fonction Windows

* Créer des requêtes permettant de : Imputer la moyenne des valeurs cohérentes aux valeurs incohérentes; Standardiser les formats de date; Remplacer les valeurs NULL ou manquantes; Supprimer les colonnes désuettes; Supprimer les duplications présumées; Décomposer une colonne en colonnes individuelles à l'aide de délimiteurs :
